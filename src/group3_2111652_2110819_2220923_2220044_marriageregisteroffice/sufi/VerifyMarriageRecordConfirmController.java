 ...
 * @author User
 */
public class VerifyMarriageRecordConfirmController implements Initializable {
    ...
    @FXML
    private void approveMarriageRecord(MouseEvent event) {
    }

    @FXML
    private void rejectMarriageRecord(MouseEvent event) {
    }
